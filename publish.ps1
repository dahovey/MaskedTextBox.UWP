...
. nuget pack .\src\MaskedTextBox.UWP\MaskedTextBox.UWP.nuspec -OutputDirectory .\build

. nuget push .\build\HoveyTech.MaskedTextBox.UWP.*.nupkg -Source https://www.nuget.org/api/v2/package